...
| @azure/functions-extensions-base | 0.3.0 | MIT | Microsoft | https://github.com/Azure/azure-functions-nodejs-extensions-base#readme |
| @azure/functions | 3.5.1 | MIT | Microsoft | https://github.com/Azure/azure-functions-nodejs-library |
| @azure/functions | 4.16.0 | MIT | Microsoft | https://github.com/Azure/azure-functions-nodejs-library |
...
| @azure/msal-browser | 5.11.0 | MIT | Microsoft | https://github.com/AzureAD/microsoft-authentication-library-for-js.git |
| @azure/msal-common | 16.6.2 | MIT | Microsoft | https://github.com/AzureAD/microsoft-authentication-library-for-js.git |
| @azure/msal-node | 5.2.2 | MIT | Microsoft | https://github.com/AzureAD/microsoft-authentication-library-for-js.git |
...
| @ganakailabs/cloudeval-signalstory-rules | 0.1.3 | UNLICENSED | NOASSERTION | NOASSERTION |
...
| @microsoft/applicationinsights-web-snippet | 1.2.3 | MIT | NOASSERTION | https://github.com/microsoft/ApplicationInsights-JS/tree/main/tools/applicationinsights-web-snippet |
...
| @sindresorhus/is | 4.6.0 | MIT | Sindre Sorhus | sindresorhus/is |
...
| acorn-import-attributes | 1.9.5 | MIT | Sven Sauleau <sven@sauleau.com> | https://github.com/xtuc/acorn-import-attributes |
| acorn | 8.15.0 | MIT | NOASSERTION | https://github.com/acornjs/acorn |
| agent-base | 7.1.4 | MIT | Nathan Rajlich <nathan@tootallnate.net> (http://n8.io/) | https://github.com/TooTallNate/proxy-agents.git |
| ansi-escapes | 6.2.1 | MIT | Sindre Sorhus | sindresorhus/ansi-escapes |
| ansi-escapes | 7.2.0 | MIT | Sindre Sorhus | sindresorhus/ansi-escapes |
| ansi-regex | 5.0.1 | MIT | Sindre Sorhus | chalk/ansi-regex |
| ansi-regex | 6.2.2 | MIT | Sindre Sorhus | chalk/ansi-regex |
| ansi-styles | 4.3.0 | MIT | Sindre Sorhus | chalk/ansi-styles |
| ansi-styles | 6.2.3 | MIT | Sindre Sorhus | chalk/ansi-styles |
| any-promise | 1.3.0 | MIT | Kevin Beaty | http://github.com/kevinbeaty/any-promise |
| applicationinsights | 3.15.0 | MIT | Microsoft Application Insights Team | https://github.com/microsoft/ApplicationInsights-node.js |
| asciichart | 1.5.25 | MIT | Igor Kroitor | https://github.com/kroitor/asciichart |
| auto-bind | 5.0.1 | MIT | Sindre Sorhus | sindresorhus/auto-bind |
| buffer-equal-constant-time | 1.0.1 | BSD-3-Clause | GoInstant Inc., a salesforce.com company | git@github.com:goinstant/buffer-equal-constant-time.git |
| bundle-name | 4.1.0 | MIT | Sindre Sorhus | sindresorhus/bundle-name |
| chalk | 4.1.2 | MIT | NOASSERTION | chalk/chalk |
| chalk | 5.6.2 | MIT | NOASSERTION | chalk/chalk |
| char-regex | 1.0.2 | MIT | Richie Bendall <richiebendall@gmail.com> | https://github.com/Richienb/char-regex.git |
| ci-info | 3.9.0 | MIT | Thomas Watson Steen <w@tson.dk> (https://twitter.com/wa7son) | https://github.com/watson/ci-info |
| cjs-module-lexer | 2.2.0 | MIT | Guy Bedford | https://github.com/nodejs/cjs-module-lexer#readme |
| cli-boxes | 3.0.0 | MIT | Sindre Sorhus | sindresorhus/cli-boxes |
| cli-cursor | 4.0.0 | MIT | Sindre Sorhus | sindresorhus/cli-cursor |
| cli-highlight | 2.1.11 | ISC | Felix Becker <felix.b@outlook.com> | https://github.com/felixfbecker/cli-highlight#readme |
| cli-spinners | 2.9.2 | MIT | Sindre Sorhus | sindresorhus/cli-spinners |
| cli-table3 | 0.6.5 | MIT | James Talmage | https://github.com/cli-table/cli-table3 |
| cli-truncate | 3.1.0 | MIT | Sindre Sorhus | sindresorhus/cli-truncate |
| cliui | 7.0.4 | ISC | Ben Coe <ben@npmjs.com> | yargs/cliui |
| cliui | 8.0.1 | ISC | Ben Coe <ben@npmjs.com> | yargs/cliui |
| code-excerpt | 4.0.0 | MIT | vdemedes | vadimdemedes/code-excerpt |
| color-convert | 2.0.1 | MIT | Heather Arthur <fayearthur@gmail.com> | Qix-/color-convert |
| color-name | 1.1.4 | MIT | DY <dfcreative@gmail.com> | https://github.com/colorjs/color-name |
| commander | 12.1.0 | MIT | TJ Holowaychuk <tj@vision-media.ca> | git+https://github.com/tj/commander.js.git |
| convert-to-spaces | 2.0.1 | MIT | Vadim Demedes <vdemedes@gmail.com> | vadimdemedes/convert-to-spaces |
| cookie | 0.7.2 | MIT | Roman Shtylman <shtylman@gmail.com> | jshttp/cookie |
...
| default-browser-id | 5.0.1 | MIT | Sindre Sorhus | sindresorhus/default-browser-id |
| default-browser | 5.5.0 | MIT | Sindre Sorhus | sindresorhus/default-browser |
| define-lazy-prop | 3.0.0 | MIT | Sindre Sorhus | sindresorhus/define-lazy-prop |
...
| eastasianwidth | 0.2.0 | MIT | Masaki Komagata | git://github.com/komagata/eastasianwidth.git |
...
| emojilib | 2.4.0 | MIT | Mu-An Chiou <me@muanchiou.com> | https://github.com/muan/emojilib#readme |
| environment | 1.1.0 | MIT | Sindre Sorhus | sindresorhus/environment |
| escalade | 3.2.0 | MIT | Luke Edwards | lukeed/escalade |
| escape-string-regexp | 2.0.0 | MIT | Sindre Sorhus | sindresorhus/escape-string-regexp |
...
| https-proxy-agent | 7.0.6 | MIT | Nathan Rajlich <nathan@tootallnate.net> (http://n8.io/) | https://github.com/TooTallNate/proxy-agents.git |
| iconv-lite | 0.6.3 | MIT | Alexander Shtuchkin <ashtuchkin@gmail.com> | https://github.com/ashtuchkin/iconv-lite |
| import-in-the-middle | 2.0.6 | Apache-2.0 | Bryan English <bryan.english@datadoghq.com> | https://github.com/nodejs/import-in-the-middle#readme |
| import-in-the-middle | 3.0.1 | Apache-2.0 | Bryan English <bryan.english@datadoghq.com> | https://github.com/nodejs/import-in-the-middle#readme |
| indent-string | 5.0.0 | MIT | Sindre Sorhus | sindresorhus/indent-string |
| inherits | 2.0.4 | ISC | NOASSERTION | git://github.com/isaacs/inherits |
| ink-scroll-view | 0.3.6 | MIT | ByteLand Technology <github@byteland.app> | https://www.byteland.app/opensource/ink-scroll-view |
| ink-spinner | 4.0.3 | MIT | Vadim Demedes | vadimdemedes/ink-spinner |
| ink-syntax-highlight | 2.0.2 | MIT | Vitalii Sashyn | vsashyn/ink-syntax-highlight |
| ink-text-input | 5.0.1 | MIT | Vadim Demedes | vadimdemedes/ink-text-input |
| ink | 4.4.1 | MIT | Vadim Demedes | vadimdemedes/ink |
| is-ci | 3.0.1 | MIT | Thomas Watson Steen <w@tson.dk> (https://twitter.com/wa7son) | https://github.com/watson/is-ci |
| is-docker | 3.0.0 | MIT | Sindre Sorhus | sindresorhus/is-docker |
| is-fullwidth-code-point | 3.0.0 | MIT | Sindre Sorhus | sindresorhus/is-fullwidth-code-point |
| is-fullwidth-code-point | 4.0.0 | MIT | Sindre Sorhus | sindresorhus/is-fullwidth-code-point |
| is-inside-container | 1.0.0 | MIT | Sindre Sorhus | sindresorhus/is-inside-container |
...
| is-wsl | 3.1.1 | MIT | Sindre Sorhus | sindresorhus/is-wsl |
| js-tokens | 4.0.0 | MIT | Simon Lydell | lydell/js-tokens |
| jsonwebtoken | 9.0.3 | MIT | auth0 | https://github.com/auth0/node-jsonwebtoken |
| jwa | 2.0.1 | MIT | Brian J. Brennan <brianloveswords@gmail.com> | git://github.com/brianloveswords/node-jwa.git |
| jws | 4.0.1 | MIT | Brian J Brennan | git://github.com/brianloveswords/node-jws.git |
| lodash.camelcase | 4.3.0 | MIT | John-David Dalton <john.david.dalton@gmail.com> (http://allyoucanleet.com/) | https://lodash.com/ |
| lodash.includes | 4.3.0 | MIT | John-David Dalton <john.david.dalton@gmail.com> (http://allyoucanleet.com/) | https://lodash.com/ |
| lodash.isboolean | 3.0.3 | MIT | John-David Dalton <john.david.dalton@gmail.com> (http://allyoucanleet.com/) | https://lodash.com/ |
| lodash.isinteger | 4.0.4 | MIT | John-David Dalton <john.david.dalton@gmail.com> (http://allyoucanleet.com/) | https://lodash.com/ |
| lodash.isnumber | 3.0.3 | MIT | John-David Dalton <john.david.dalton@gmail.com> (http://allyoucanleet.com/) | https://lodash.com/ |
| lodash.isplainobject | 4.0.6 | MIT | John-David Dalton <john.david.dalton@gmail.com> (http://allyoucanleet.com/) | https://lodash.com/ |
| lodash.isstring | 4.0.1 | MIT | John-David Dalton <john.david.dalton@gmail.com> (http://allyoucanleet.com/) | https://lodash.com/ |
| lodash.once | 4.1.1 | MIT | John-David Dalton <john.david.dalton@gmail.com> (http://allyoucanleet.com/) | https://lodash.com/ |
| lodash | 4.18.1 | MIT | John-David Dalton <john.david.dalton@gmail.com> | https://lodash.com/ |
| logform | 2.7.0 | MIT | Charlie Robbins <charlie.robbins@gmail.com> | https://github.com/winstonjs/logform#readme |
| long | 4.0.0 | Apache-2.0 | Daniel Wirtz <dcode@dcode.io> | https://github.com/dcodeIO/long.js.git |
| long | 5.3.2 | Apache-2.0 | Daniel Wirtz <dcode@dcode.io> | https://github.com/dcodeIO/long.js.git |
...
| mimic-fn | 2.1.0 | MIT | Sindre Sorhus | sindresorhus/mimic-fn |
| module-details-from-path | 1.0.4 | MIT | Thomas Watson <w@tson.dk> (https://wa.tson.dk/) | https://github.com/watson/module-details-from-path#readme |
| ms | 2.1.3 | MIT | NOASSERTION | vercel/ms |
| mz | 2.7.0 | MIT | Jonathan Ong | normalize/mz |
| node-emoji | 2.2.0 | MIT | Daniel Bugl | https://github.com/omnidan/node-emoji |
| object-assign | 4.1.1 | MIT | Sindre Sorhus | sindresorhus/object-assign |
| onetime | 5.1.2 | MIT | Sindre Sorhus | sindresorhus/onetime |
| open | 10.2.0 | MIT | Sindre Sorhus | sindresorhus/open |
| parse5-htmlparser2-tree-adapter | 6.0.1 | MIT | Ivan Nikulin <ifaaan@gmail.com> (https://github.com/inikulin) | https://github.com/inikulin/parse5 |
| parse5 | 5.1.1 | MIT | Ivan Nikulin <ifaaan@gmail.com> (https://github.com/inikulin) | https://github.com/inikulin/parse5 |
| parse5 | 6.0.1 | MIT | Ivan Nikulin <ifaaan@gmail.com> (https://github.com/inikulin) | https://github.com/inikulin/parse5 |
| patch-console | 2.0.0 | MIT | vdemedes | vadimdemedes/patch-console |
| pg-int8 | 1.0.1 | ISC | NOASSERTION | https://github.com/charmander/pg-int8 |
| pg-protocol | 1.14.0 | MIT | NOASSERTION | git://github.com/brianc/node-postgres.git |
| pg-types | 2.2.0 | MIT | Brian M. Carlson | https://github.com/brianc/node-pg-types |
| postgres-array | 2.0.0 | MIT | Ben Drucker | bendrucker/postgres-array |
| postgres-bytea | 1.0.1 | MIT | Ben Drucker | bendrucker/postgres-bytea |
| postgres-date | 1.0.7 | MIT | Ben Drucker | bendrucker/postgres-date |
| postgres-interval | 1.2.0 | MIT | Ben Drucker | bendrucker/postgres-interval |
| protobufjs | 8.4.1 | BSD-3-Clause | Daniel Wirtz <dcode+protobufjs@dcode.io> | protobufjs/protobuf.js |
| react-devtools-core | 4.28.5 | MIT | NOASSERTION | https://github.com/facebook/react.git |
| react-reconciler | 0.29.2 | MIT | NOASSERTION | https://reactjs.org/ |
| react | 18.3.1 | MIT | NOASSERTION | https://reactjs.org/ |
| readable-stream | 3.6.2 | MIT | NOASSERTION | git://github.com/nodejs/readable-stream |
...
| require-in-the-middle | 8.0.1 | MIT | Thomas Watson Steen <w@tson.dk> (https://twitter.com/wa7son) | https://github.com/nodejs/require-in-the-middle#readme |
| restore-cursor | 4.0.0 | MIT | Sindre Sorhus | sindresorhus/restore-cursor |
| run-applescript | 7.1.0 | MIT | Sindre Sorhus | sindresorhus/run-applescript |
...
| slice-ansi | 5.0.0 | MIT | NOASSERTION | chalk/slice-ansi |
| slice-ansi | 6.0.0 | MIT | NOASSERTION | chalk/slice-ansi |
| sql.js | 1.14.1 | MIT | NOASSERTION | http://github.com/sql-js/sql.js |
| stack-utils | 2.0.6 | MIT | James Talmage | tapjs/stack-utils |
| string_decoder | 1.3.0 | MIT | NOASSERTION | https://github.com/nodejs/string_decoder |
| string-width | 4.2.3 | MIT | Sindre Sorhus | sindresorhus/string-width |
| string-width | 5.1.2 | MIT | Sindre Sorhus | sindresorhus/string-width |
| strip-ansi | 6.0.1 | MIT | Sindre Sorhus | chalk/strip-ansi |
| strip-ansi | 7.1.2 | MIT | Sindre Sorhus | chalk/strip-ansi |
| supports-color | 7.2.0 | MIT | Sindre Sorhus | chalk/supports-color |
| supports-hyperlinks | 3.2.0 | MIT | NOASSERTION | chalk/supports-hyperlinks |
| thenify-all | 1.6.0 | MIT | Jonathan Ong <me@jongleberry.com> (http://jongleberry.com) | thenables/thenify-all |
| thenify | 3.3.1 | MIT | Jonathan Ong <me@jongleberry.com> (http://jongleberry.com) | thenables/thenify |
| triple-beam | 1.4.1 | MIT | Charlie Robbins <charlie.robbins@gmail.com> | https://github.com/winstonjs/triple-beam#readme |
...
| type-fest | 0.12.0 | (MIT OR CC0-1.0) | Sindre Sorhus | sindresorhus/type-fest |
| type-fest | 3.13.1 | (MIT OR CC0-1.0) | Sindre Sorhus | sindresorhus/type-fest |
...
| uuid | 8.3.2 | MIT | NOASSERTION | https://github.com/uuidjs/uuid.git |
| widest-line | 4.0.1 | MIT | Sindre Sorhus | sindresorhus/widest-line |
| winston-transport | 4.9.0 | MIT | Charlie Robbins <charlie.robbins@gmail.com> | https://github.com/winstonjs/winston-transport#readme |
| wrap-ansi | 7.0.0 | MIT | Sindre Sorhus | chalk/wrap-ansi |
| wrap-ansi | 8.1.0 | MIT | Sindre Sorhus | chalk/wrap-ansi |
| ws | 7.5.11 | MIT | Einar Otto Stangvik <einaros@gmail.com> (http://2x.io) | https://github.com/websockets/ws |
| ws | 8.21.0 | MIT | Einar Otto Stangvik <einaros@gmail.com> (http://2x.io) | https://github.com/websockets/ws |
| wsl-utils | 0.1.0 | MIT | Sindre Sorhus | sindresorhus/wsl-utils |
| xtend | 4.0.2 | MIT | Raynos <raynos2@gmail.com> | https://github.com/Raynos/xtend |
| y18n | 5.0.8 | ISC | Ben Coe <bencoe@gmail.com> | https://github.com/yargs/y18n |
| yaml | 2.9.0 | ISC | Eemeli Aro <eemeli@gmail.com> | https://eemeli.org/yaml/ |
| yargs-parser | 20.2.9 | ISC | Ben Coe <ben@npmjs.com> | https://github.com/yargs/yargs-parser.git |
| yargs-parser | 21.1.1 | ISC | Ben Coe <ben@npmjs.com> | https://github.com/yargs/yargs-parser.git |
| yargs | 16.2.0 | MIT | NOASSERTION | https://yargs.js.org/ |
| yargs | 17.7.2 | MIT | NOASSERTION | https://yargs.js.org/ |
| yoga-wasm-web | 0.3.3 | MIT | NOASSERTION | shuding/yoga-wasm-web |
| zod | 3.25.76 | MIT | Colin McDonnell <zod@colinhacks.com> | https://zod.dev |
