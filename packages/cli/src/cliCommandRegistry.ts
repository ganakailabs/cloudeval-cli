...
export const cliCommands: CliCommandMetadata[] = [
  ...
  },
  {
    ...
    workflows: ["validate template", "validate parse", "validate tests"],
  },
  {
    name: "iac",
    description: "Detect and index local IaC resources for IDE and agent workflows",
    domain: "validation",
    options: [
      "detect",
      "index",
    ...
    workflows: ["iac detect", "iac index"],
  },
  {
    name: "findings",
    description: "Inspect IDE findings, evidence, and draft fix proposals",
    domain: "validation",
    options: [
      "evidence",
      "draft-fix",
    ...
    workflows: ["findings evidence", "findings draft-fix"],
  },
  {
    name: "ci",
  ...
  {
    name: "graph",
    description: "Fetch scoped graph context for IDE architecture views",
    domain: "projects",
    options: [
      "neighborhood",
      "--project",
